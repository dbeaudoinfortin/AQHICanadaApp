...
public class Grib2Parser {
    ...
    public static RawImage parse(byte[] bytes) throws IOException {
    ...
    private static RawImage parseData(byte[] bytes, int sectionStart, long sectionLength, int dataTemplateNumber) {
